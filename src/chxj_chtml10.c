...
s_chtml10_start_form_tag(void *pdoc, Node *node) 
{
  ...
  if (attr_action) {
    ...
    if (q) {
      new_hidden_tag = chxj_form_action_to_hidden_tag(r, doc->pool, attr_action, 0, post_flag, &new_query_string, CHXJ_TRUE, CHXJ_FALSE, chtml10->entryp);
 ...
 */
static char *
s_chtml10_start_select_tag(void *pdoc, Node *node)
{
  chtml10_t    *chtml10;
  Doc          *doc;
  request_rec  *r;
 ...
 */
static char *
s_chtml10_start_blockquote_tag(void *pdoc, Node *node)
{
  chtml10_t *chtml10;
  Doc       *doc;
  Attr      *attr;
 ...
 */
static char *
s_chtml10_start_dir_tag(void *pdoc, Node *node)
{
  chtml10_t *chtml10;
  Doc       *doc;
  Attr      *attr;
 ...
 */
static char *
s_chtml10_start_dl_tag(void *pdoc, Node *node)
{
  chtml10_t *chtml10;
  Doc       *doc;
  Attr      *attr;
 ...
 */
static char *
s_chtml10_start_dt_tag(void *pdoc, Node *node)
{
  chtml10_t *chtml10;
  Doc *doc;
  Attr *attr;
