...
static char *s_chtml50_link_tag           (void *pdoc, Node *node);
static char *s_chtml50_start_span_tag     (void *pdoc, Node *node);
static char *s_chtml50_end_span_tag       (void *pdoc, Node *node);
static char *s_chtml50_style_tag       (void *pdoc, Node *node);
...
tag_handler chtml50_handler[] = {
  ...
  /* tagSPAN */
  {
    s_chtml50_start_span_tag,
    s_chtml50_end_span_tag,
  },
  /* tagTEXT */
  {
    s_chtml50_text_tag,
...
s_chtml50_start_font_tag(void *pdoc, Node *node) 
{
  ...
  if (attr_color || attr_size) {
    ...
    W_L(">");
    chtml50_flags_t *flg = (chtml50_flags_t *)apr_palloc(doc->pool, sizeof(*flg));
 ...
 */
static char *
s_chtml50_end_font_tag(void *pdoc, Node *node)
{
  chtml50_t     *chtml50;
  Doc           *doc;
  request_rec   *r;
...
s_chtml50_start_form_tag(void *pdoc, Node *node) 
{
  ...
  if (attr_action) {
    ...
    if (q) {
      new_hidden_tag = chxj_form_action_to_hidden_tag(r, doc->pool, attr_action, 0, post_flag, &new_query_string, CHXJ_TRUE, CHXJ_FALSE, chtml50->entryp);
...
s_chtml50_start_input_tag(void *pdoc, Node *node) 
{
  ...
  if (attr_value) {
    if (attr_type && (STRCASEEQ('s','S',"submit",attr_type) || STRCASEEQ('r','R',"reset",attr_type))) {
      ...
      attr_value = chxj_conv_z2h(r, attr_value, &value_len, chtml50->entryp);
    }
 ...
 */
static char *
s_chtml50_start_center_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50;
  Doc       *doc;
  Attr      *attr;
 ...
 */
static char *
s_chtml50_start_select_tag(void *pdoc, Node *node)
{
  chtml50_t   *chtml50  = GET_CHTML50(pdoc);
  Doc         *doc      = chtml50->doc;
  char        *size     = NULL;
 ...
 */
static char *
s_chtml50_start_pre_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50 = GET_CHTML50(pdoc);
  Doc       *doc     = chtml50->doc;
  Attr      *attr;
 ...
 */
static char *
s_chtml50_end_p_tag(void *pdoc, Node *node)
{
  chtml50_t   *chtml50;
  Doc         *doc;
 ...
 */
static char *
s_chtml50_start_blockquote_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50;
  Doc       *doc;
  Attr      *attr;
 ...
 */
static char *
s_chtml50_end_blockquote_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50 = GET_CHTML50(pdoc);
  Doc       *doc     = chtml50->doc;
  chtml50_flags_t *flg = (chtml50_flags_t *)node->userData;
 ...
 */
static char *
s_chtml50_end_dir_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50 = GET_CHTML50(pdoc);
  Doc       *doc = chtml50->doc;
  chtml50_flags_t *flg = (chtml50_flags_t *)node->userData;
 ...
 */
static char *
s_chtml50_start_dl_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50 = GET_CHTML50(pdoc);
  Doc       *doc     = chtml50->doc;
  Attr      *attr;
 ...
 */
static char *
s_chtml50_end_dl_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50 = GET_CHTML50(pdoc);
  Doc       *doc = chtml50->doc;
  chtml50_flags_t *flg = (chtml50_flags_t *)node->userData;
 ...
 */
static char *
s_chtml50_start_dt_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50 = GET_CHTML50(pdoc);
  Doc       *doc     = chtml50->doc;
  Attr      *attr;
 ...
 */
static char *
s_chtml50_end_dt_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50 = GET_CHTML50(pdoc);
  Doc       *doc     = chtml50->doc;
 ...
 */
static char *
s_chtml50_start_dd_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50 = GET_CHTML50(pdoc);
  Doc       *doc     = chtml50->doc;
  Attr      *attr;
 ...
 */
static char *
s_chtml50_end_dd_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50 = GET_CHTML50(pdoc);
  Doc       *doc     = chtml50->doc;
 ...
 */
static char *
s_chtml50_end_marquee_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50 = GET_CHTML50(pdoc);
  Doc       *doc     = chtml50->doc;
 ...
 */
static char *
s_chtml50_start_blink_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50 = GET_CHTML50(pdoc);
  Doc       *doc     = chtml50->doc;
  Attr      *attr;
 ...
 */
static char *
s_chtml50_end_blink_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50 = GET_CHTML50(pdoc);
  Doc       *doc     = chtml50->doc;
 ...
 */
static char *
s_chtml50_end_menu_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50 = GET_CHTML50(pdoc);
  Doc       *doc = chtml50->doc;
  chtml50_flags_t *flg = (chtml50_flags_t *)node->userData;
 ...
 */
static char *
s_chtml50_link_tag(void *pdoc, Node *node)
{
  chtml50_t     *chtml50;
  Doc           *doc;
  Attr          *attr;
 ...
 */
static char *
s_chtml50_start_span_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50;
  Doc *doc;
  Attr *attr;
  ...
  if (attr_color || attr_size || attr_align || attr_blink || attr_marquee) {
    chtml50_flags_t *flg = apr_palloc(doc->pool, sizeof(*flg));
    memset(flg, 0, sizeof(*flg));
    if (attr_blink) {
      W_L("<blink>");
      flg->with_blink_flag = 1;
 ...
 */
static char *
s_chtml50_end_span_tag(void *pdoc, Node *node)
{
  chtml50_t *chtml50 = GET_CHTML50(pdoc);
  Doc *doc = chtml50->doc;
 ...
 */
static char *
s_chtml50_style_tag(void *pdoc, Node *node)
{
  chtml50_t     *chtml50;
  Doc           *doc;
  Attr          *attr;
